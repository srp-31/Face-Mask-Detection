...
class DetectFaceClassifyMask:
    ...
    def __init__(self, face_folder, mask_classifier, confidence):
        ...
        prototxtPath = os.path.join(face_folder, "deploy.prototxt")
        weightsPath = os.path.join(face_folder,
                                   "res10_300x300_ssd_iter_140000.caffemodel")
        self.faceNet = cv2.dnn.readNet(prototxtPath, weightsPath)

        # load the face mask detector model from disk
        print("[INFO] loading face mask detector model...")
        self.maskNet = load_model(mask_classifier)
